            ...
            std::thread::Builder::new()
                ...
                .spawn(move || {
                    for line in BufReader::new(stderr).lines().map_while(Result::ok) {
                        eprintln!("Piwaku Computer Use: {line}");
                    }
                })?;
        }
